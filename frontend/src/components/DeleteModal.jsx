    ...
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        ...
        <div className="relative w-96 mx-auto max-w-full">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-800 text-TextWhite outline-none focus:outline-none">
            {/* Header */}
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
              <h2 className="text-3xl font-semibold">Delete post</h2>
              <button
                className="p-1 ml-auto  border-0  opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
            ...
            <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
              <AnimatedMotion animationName="buttonAnimation">
                <button
                  className="editText focus:ring focus:ring-red-500 bg-red-400 text-TextWhite text-lg"
                  type="button"
                  onClick={() => setDeleteModal(false)}
                >
                  Cancel
              ...
              <AnimatedMotion animationName="buttonAnimation">
                <button
                  className="editText focus:ring focus:ring-green-500 bg-green-400 text-TextWhite text-lg"
                  type="button"
