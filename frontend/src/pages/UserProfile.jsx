      ...
      <AnimatedMotion animationName="pageAnimation">
        ...
        <div className="flex-col flex md:flex-row justify-evenly items-center pt-10">
          ...
          <div className="mt-10">
            ...
            <p className="text-center pt-3 font-bold  text-xl">
              {user?.userAward}
            </p>
          </div>
        </div>
        <div className="mt-20 text-center border-b pb-12">
          <h1 className="text-4xl font-medium ">{user?.fullname}</h1>
          <p>{user?.email}</p>
        </div>

        <div className="p-4 md:p-10 flex justify-center items-center">
          <div className="pt-8 md:mt-5 mt-0">
            <div className=" my-auto mx-auto">
              <div className="md:grid md:grid-cols-3 flex justify-around text-center order-last md:order-first mt-20 md:mt-0">
